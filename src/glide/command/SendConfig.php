...
class SendConfig extends Command
{
    ...
    {
        //获取默认配置文件
        $content = file_get_contents(root_path() . 'vendor/zzstudio/think-glide/src/config.php');

        $configPath = config_path() . '/';
        $configFile = $configPath . 'glide.php';
        ...
        $output->writeln('create glide config ok');
    }
